...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        {!! Form::select('type', ['Entreprise' => 'Entreprise', 'Pole emploi' => 'Pole emploi', 'Conseil départemental' => 'Conseil départemental'], null, ['class' => 'form-control', 'placeholder' => 'Choisissez un type']) !!}
    </div>
</div>
<div class="form-group row">
